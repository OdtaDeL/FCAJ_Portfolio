...
const searchableContent = [
    ...
    { label: 'Workshop', path: '/workshop', keywords: ['lab', 'hands-on', 'tutorial', 'spendwise'] },
    { label: '4.1 Overview', path: '/workshop/4.1-Overview', keywords: ['overview', 'architecture', 'spendwise', 'introduction', 'ecs', 'rds'] },
    { label: '4.2 Prerequisites', path: '/workshop/4.2-Prerequiste', keywords: ['prerequisites', 'terraform', 'aws cli', 'docker', 'nestjs', 'amplify'] },
    { label: '4.3 Frontend Setup', path: '/workshop/4.3-Frontend', keywords: ['frontend', 'amplify', 'nextjs', 'auth', 'rds', 'alb'] },
    { label: '4.4 Backend Setup', path: '/workshop/4.4-Backend', keywords: ['backend', 'nestjs', 'typeorm', 'postgresql', 'cognito'] },
    ...
    { label: '4.4.2 Data Layer', path: '/workshop/4.4-Backend/4.4.2-Data', keywords: ['typeorm', 'postgresql', 'schema', 'transactions', 'budgets', 'categories'] },
    { label: '4.4.3 Storage Layer', path: '/workshop/4.4-Backend/4.4.3-Storage', keywords: ['secrets manager', 'configuration', 'env', 'credentials'] },
    { label: '4.4.4 REST APIs', path: '/workshop/4.4-Backend/4.4.4-Functions', keywords: ['api', 'controllers', 'services', 'transactions', 'budgets'] },
